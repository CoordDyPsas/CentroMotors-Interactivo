...
body{font-family:Inter,sans-serif;background:#4f4f4f;min-height:100vh;display:flex;justify-content:center;align-items:center;position:relative;overflow:hidden}
