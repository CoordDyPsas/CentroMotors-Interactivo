...
function buildEmailHTML(branchName, rows) {
  ...
  rows.forEach(function(r, i) {
    ...
    cards += '<div style="background:#fff;border:1px solid #eee;border-left:4px solid ' + c + ';border-radius:8px;padding:14px 16px;margin-bottom:8px">'
      ...
      + '<span style="font-size:11px;font-weight:600;padding:2px 8px;border-radius:4px;background:rgba(255,105,0,0.12);color:#ff6900">' + esc((r.piso || 'pb').toUpperCase()) + '</span>'
      + '<span style="font-size:12px;color:#888">' + esc(r.ubicacion) + '</span></div></div>'
